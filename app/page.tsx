  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <main className="flex-1">
        ...
        {/* Logos Section */}
        <section className="w-full py-12 border-y bg-muted/30 dark:bg-white">
  <div className="container px-4 md:px-6">
    <div className="flex flex-col items-center justify-center space-y-4 text-center">
      <p className="text-sm font-medium text-muted-foreground dark:text-muted-foreground/100">
      ...
      <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 lg:gap-16">
        {[1, 2, 3, 4, 5].map((i) => (
          <Image
            ...
            width={120}
            height={60}
            className="w-auto h-8 transition-all opacity-70 grayscale hover:opacity-100 hover:grayscale-0 dark:opacity-100 dark:grayscale-0"
          />
        ))}
      </div>
    </div>
